...
import 'package:job_application/old/viewJobDetails.dart';
                    ...
                    children: <Widget>[
                      Padding(
                        padding: EdgeInsets.only(
                            right: 32, left: 0, top: 40, bottom: 32),
                        child: Text(
                          "Your \napplications",
                          style: TextStyle(
                              fontSize: 32,
                              ...
                              child: Container(
                                ...
                                child: ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      String companyID =
                                          jobs[index].data['c_id'];

                                      String jobTitle =
                                          jobs[index].data['job_title'];

                                      String location =
                                          jobs[index].data['location'];

                                      String qualification =
                                          jobs[index].data['qualification'];

                                      String description =
                                          jobs[index].data['description'];

                                      String type = jobs[index].data['type'];

                                      String doc_id =
                                          jobs[index].documentID.toString();
                                    ...
                                    return Container(
                                      ...
                                      child: ListView.builder(
                                          ...
                                          itemBuilder:
                                            ...
                                            String qualification = jobs[index]
                                                .data['qualification'];
                                            ...
                                            String type =
                                                jobs[index].data['type'];

                                            String doc_id = jobs[index]
                                                .documentID
                                                .toString();
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => JobViewX(cimg, cname, type,
                                  loc, title, des, qual, doc_id)),
                        );
                      },
                      color: Colors.black,
                      child: Text(
