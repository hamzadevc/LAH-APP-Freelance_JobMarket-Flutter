...
class _WalletState extends State<Wallet> {
  ...
  Widget build(BuildContext context) {
    ...
    var CardNo = CRUD.CardNo.substring(CRUD.CardNo.length - 4);
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            CircleAvatar(
                              ...
                              child: ClipOval(
                                child: Image.network(CRUD.imgUrl, fit: BoxFit.contain,),
                              ),
                            )
                          ],
                        ),
        ...
        Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text("**** **** **** $CardNo", style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.w700, letterSpacing: 2.0),),
                  ...
                  children: <Widget>[
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(CRUD.name, style: TextStyle(fontSize: 16, color: Colors.grey[100], fontWeight: FontWeight.w700, letterSpacing: 2.0),),
                      ],
                    ),
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(CRUD.expiry, style: TextStyle(fontSize: 16, color: Colors.grey[100], fontWeight: FontWeight.w700, letterSpacing: 2.0),),
                      ],
                    ),
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(CRUD.Cvv, style: TextStyle(fontSize: 16, color: Colors.grey[100], fontWeight: FontWeight.w700, letterSpacing: 2.0),),
                      ],
                    )
                  ],
                )
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: <Widget>[
                              Text("Recent Payments", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 24, color: Colors.black),),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text("Order Completed", style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: Colors.grey[500]),),
                                      ],
                                    ),
                                  ),
                                  Column(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text("Order Canceled", style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: Colors.grey[500]),),
                                      ],
                                    ),
                                  ),
